...
struct CardView: View {
    ...
    var body: some View {
        ZStack {
            Image(UserDefaultsService.shared.isLightMode ? "cardBackgroundLight" : "cardBackgroundDark", bundle: nil)
                .resizable()
                .cornerRadius(32)
            VStack {
                HStack(alignment: .top) {
                    ...
                    Spacer()
                    Image("big_sun", bundle: nil).padding(.top, -40).padding(.trailing, -40)
                }
                Spacer()
